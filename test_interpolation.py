...
back_to_back_number = 1575000000
number_format = "float"
bytes_per_pixel = "4"
scanner = "test_interpolation_20"
phantom_name = "test_interpolation_20"
...
fov_y = 400. 
#fov_z = 500. 
fov_z = 480. # for the 20 cm interpolation 
...
# Maps path
sens_maps_path= '/home/baran/git/CastorTools/castor_sensitivity_maps/test_interpolation'
...
def create_sensitivity_parallel (results_path):
	...
	try:
		...
		print "File {0} opened successfully!".format(results_path)
	except:
...
#normal			if (entry.comptonPhantom1 == 0 and entry.comptonPhantom1 == 0):
			if (entry.comptonPhantom1 == 0 and entry.comptonPhantom1 == 0 and entry.sourcePosZ1 <= 240. and entry.sourcePosZ2 <= 240.):	# for the 20x20x20 interpolation
				prompt += 1
...
if __name__ == '__main__':
	...
	maps_list = glob.glob(sens_maps_path+'/*.root')[0:63]
	print len(maps_list)
